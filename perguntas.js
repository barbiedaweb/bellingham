criaCartao (
    ...
    'Ela funciona através da transformação da luz do sol em eletricidade.' )
    
    criaCartao (
    'Quimica',
    'Como calcular a molaridade ',
    'Utiliza-se a formula Molaridade(M) = (Moles de Soluto) / (Volume da Solução em Litros.' )
    ...
    'É gerada a partir da força do vento, que é transformada em energia elétrica por meio de aerogeradores.' )
    ...
    'Dividindo a massa (m) da matéria por sua massa molar (M). ' )
    ...
    criaCartao (
    'Biologia',
    'Quais são os orgãos do sistema urinário',
    'Os órgãos do sistema urinário são: Dois rins, Dois ureteres, Uma bexiga urinária, Uma uretra.' )
    
    criaCartao (
    'Biologia ',
    'Quais sao os efeitos das drogas sintéticas ao longo do tempo',
    ...
    criaCartao (
    'Física',
    'quais sao os beneficios da energia hidrelétrica',
    'A hidreletricidade contribui para o armazenamento de água potável. Os reservatórios das usinas hidrelétricas coletam a água da chuva, que pode então ser usada para consumo ou para irrigação.' )
